class OLT_ALU {
    khaiCSDL_OLT_ALU( card,  pon,  id,  vlan) {
    ...
    //khai megawan modem igate 
     khaiMegawan_OLT_ALU( card,  pon,  id,  vlan,  tocdo,  tenkenh)
    {
    ...
    //ham khai camera ha tien vlan 3594  cho modem igate 
     khaiCamera_vlan3594_OLT_ALU( card,  pon,  id,  vlan,  tocdo,  tenkenh)
    {
         tocdoprofile = tocdo * 1024;
         tocdokh = (int)(tocdoprofile * 1.1);
           "configure qos profiles ingress-qos VPN_TC2 dot1-p0-tc 2 dot1-p1-tc 2 dot1-p2-tc 2 dot1-p3-tc 2 dot1-p4-tc 2 dot1-p5-tc 2 dot1-p6-tc 2 dot1-p7-tc 2\r\n" +
     ...
     khaiCamera_vlan3594_HT_OLT_ALU( card,  pon,  id,  vlan,  tocdo,  tenkenh)
    {
         tocdoprofile = tocdo * 1024;
         tocdokh = (int)(tocdoprofile * 1.1);
         s = "================//Khai profile//======================= \r\n" +
     ...
     khaiCamera_Vlink_OLT_ALU( card,  pon,  id,  vlan)
            {
                 s = "// Khai báo profile \r\n" +
                          "configure qos profiles ingress-qos VPN_TC2 dot1-p0-tc 2 dot1-p1-tc 2 dot1-p2-tc 2 dot1-p3-tc 2 dot1-p4-tc 2 dot1-p5-tc 2 dot1-p6-tc 2 dot1-p7-tc 2\r\n" +
                            "configure qos profiles shaper CAMERA_CAT15M committed-info-rate 0 committed-burst-size 0 excess-info-rate 15000 type singletokenbucketgpon\r\n" +
     ...
     khaiCamera_Vlink_HT_OLT_ALU( card,  pon,  id,  vlan)
     {
          s = "// Khai báo profile \r\n" +
                     "configure qos profiles ingress-qos VPN_TC2 dot1-p0-tc 2 dot1-p1-tc 2 dot1-p2-tc 2 dot1-p3-tc 2 dot1-p4-tc 2 dot1-p5-tc 2 dot1-p6-tc 2 dot1-p7-tc 2\r\n" +
                     "configure qos profiles shaper CAMERA_CAT15M committed-info-rate 0 committed-burst-size 0 excess-info-rate 15000 type singletokenbucketgpon\r\n" +
      ...
      //ham khai megawan vlink 1000
       khaiMegawan_Vlink1000_OLT_ALU( card,  pon,  id,  vlan,  tocdo,  tenkenh)
      {
           tocdoprofile = tocdo * 1024;
           tocdokh = (int)(tocdoprofile * 1.1);
           s = "================//Khai profile//======================= \r\n" +
     ...
     khaiONU_OLT_ALU( card,  pon,  id,  pw)
    {
     ...
     khaiNet_OLT_ALU( card,  pon,  id,  vlanNet,  vlanql)
    {
    ...
    //Khai net vlan 1000
     ...
     khaiNetVlan1000_OLT_ALU( card,  pon,  id,  vlanNet,  vlanql)
    {
     ...
     KhaiVlanQL_OLT_ALU( card,  pon,  id,  vlanql)
            {
     ...
     khaiMyTV_OLT_ALU( card,  pon,  id,  vlanVod)
            {
     ...
     khaiONU_240_OLT_ALU( card,  pon,  id,  pw)
            {
     ...
     khaiNet_240_OLT_ALU( card,  pon,  id,  vlanNet,  vlanql)
            {
     ...
     khaiMyTV_240( card,  pon,  id,  vlanVod)
            {
